...
export default function ITServicesCard() {
  return (
    <InteractiveCard className="relative mb-20 md:mb-40 group">
      ...
      <div className="relative bg-[#fff8e6]/95 backdrop-blur-3xl border border-[#D4AF37]/40 rounded-[50px] p-8 sm:p-10 md:p-16 shadow-[0_0_60px_rgba(212,175,55,0.35)]">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="order-1 md:order-2 h-[260px] sm:h-[320px] md:h-[380px] rounded-3xl overflow-hidden border border-[#D4AF37]/30 shadow-inner relative">
            <img
          ...
          <div className="order-2 md:order-1">
            ...
            <p className="text-[#475569] text-base sm:text-lg mb-6 md:mb-8 leading-relaxed">
              High-performance engineering across web, mobile, AI automation, enterprise
              systems, cloud infrastructure and cybersecurity.
            </p>
