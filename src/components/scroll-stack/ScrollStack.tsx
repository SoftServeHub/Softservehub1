...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  if (useWindowScroll) {
    return (
      <div className={`relative w-full ${className}`.trim()}>
        <div className="scroll-stack-inner min-h-0 px-4 pb-[32rem] pt-[8vh] sm:px-8 md:px-12 md:pb-[40rem] md:pt-[12vh] lg:px-20">
          {children}
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-[20vh] px-4 pb-[50rem] min-h-screen sm:px-12 md:px-20">
        {children}
        <div className="scroll-stack-end w-full h-px" aria-hidden />
      </div>
    </div>
