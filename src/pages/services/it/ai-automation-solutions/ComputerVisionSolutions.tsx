    ...
    <section className="service-detail-page relative min-h-screen bg-[#fffCF0] text-[#1f1605] overflow-hidden">
      ...
      <div className="pt-28 pb-16 px-6 border-b border-[#D4AF37]/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-sm text-[#67552b] mb-6">
            ...
            <Link to="/services/it" className="hover:text-[#D4AF37] transition">IT Services</Link>
            <span className="mx-2">/</span>

            <Link to={`/services/it/${category.slug}`} className="hover:text-[#D4AF37] transition">
              {category.title}
            </Link>
            <span className="mx-2">/</span>
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          {/* Overview */}
          <div className="p-10 bg-white/70 rounded-3xl border border-[#D4AF37]/30">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.deliverySteps.map((s: any, i: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-4 font-bold text-[#0f172a] transition-colors duration-300 group-hover:text-[#1f1605] group-active:text-[#1f1605]">
                    {s.title}
                  </h3>
                  <p className="relative text-[#67552b] mt-2 leading-relaxed transition-colors duration-300 group-hover:text-[#2f2208] group-active:text-[#2f2208]">
                    {s.desc}
                  </p>
                </div>
              ))}
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.whyChoose.map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative font-bold text-[#b45309] mt-4 transition-colors duration-300 group-hover:text-[#1f1605]">
                    {w.title}
                  </h3>
          ...
          {/* Contact */}
          <div id="contact" className="p-10 bg-white/70 rounded-3xl border border-[#D4AF37]/30">
            ...
            <form onSubmit={onSubmit} className="grid md:grid-cols-2 gap-6 mt-8">
              <input
                ...
                className="p-3 rounded-xl bg-white/75 border border-[#D4AF37]/30"
              />
              ...
              <textarea
                ...
                className="md:col-span-2 p-3 rounded-xl bg-white/75 border border-[#D4AF37]/30"
              />

              <div className="md:col-span-2 flex gap-4 flex-wrap">
                <button className="px-8 py-4 bg-[#BFA45F] rounded-2xl font-semibold hover:bg-[#BFA45F] transition">
                  {content.submitLabel}
                </button>
