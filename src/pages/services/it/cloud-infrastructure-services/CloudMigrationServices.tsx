    ...
    <section className="service-detail-page relative min-h-screen bg-[#fffCF0] text-[#1f1605] overflow-hidden">
          ...
          <div className="rounded-[32px] overflow-hidden border border-[#D4AF37]/30 bg-white/70 shadow-[0_30px_100px_rgba(138,107,24,0.12)] backdrop-blur-2xl">
            ...
            <div className="relative px-8 py-16 md:px-14 md:py-20 text-center">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                <Link
                  to="/book-appointment"
                  className="px-8 py-4 bg-[#8a6b18] rounded-2xl font-semibold hover:bg-[#8a6b18] transition shadow-[0_0_40px_rgba(138,107,24,0.35)]"
                >
                  {content.primaryCta}
                </Link>
                <a
                  href="#contact"
                  className="px-8 py-4 bg-white/70 border border-[#D4AF37]/30 rounded-2xl hover:bg-white/80 transition"
                >
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          <div className="bg-white/70 p-10 rounded-3xl border border-[#D4AF37]/30">
            <h2 className="text-[#8a6b18] text-2xl md:text-3xl font-bold">Overview</h2>
          ...
          {/* Delivery */}
          <div className="bg-white/70 p-10 rounded-3xl border border-[#D4AF37]/30">
            <h2 className="text-[#b45309] text-2xl md:text-3xl font-bold">How We Deliver</h2>
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 mt-6">
              {content.deliverySteps.map((s: any, i: number) => (
                <div
                  key={s.title}
                  className="group relative overflow-hidden p-6 bg-white/75 rounded-[28px] border border-[#D4AF37]/30 transition-all duration-300 hover:-translate-y-2 hover:border-[#f6df9a]/50 hover:shadow-[0_0_35px_rgba(212,175,55,0.18)]"
                >
                  ...
                  <div className="relative font-bold mb-2 w-10 h-10 rounded-xl bg-[#BFA45F] flex items-center justify-center">
                    {i + 1}
                  </div>
                  <h3 className="relative font-semibold text-[#1f1605]">{s.title}</h3>
                  <p className="relative text-[#67552b] mt-2 leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Why Choose Us */}
          <div className="bg-white/70 p-10 rounded-3xl border border-[#D4AF37]/30">
            <h2 className="text-[#8a6b18] text-2xl md:text-3xl font-bold">Why Choose Us</h2>
            <div className="grid md:grid-cols-3 gap-6 mt-6">
              {content.whyChoose.map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative font-semibold mt-4 text-[#1f1605]">{w.title}</h3>
                  <p className="relative text-[#67552b] mt-2 leading-relaxed">{w.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Contact */}
          <div id="contact" className="bg-white/70 p-10 rounded-3xl border border-[#D4AF37]/30">
            <h2 className="text-[#b45309] text-2xl md:text-3xl font-bold">{content.contactTitle}</h2>
            ...
            <form onSubmit={onSubmit} className="grid md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="md:col-span-2 flex gap-4 flex-wrap">
                <button className="px-6 py-3 bg-[#BFA45F] rounded-xl hover:bg-[#BFA45F] transition font-semibold">
                  {content.submitLabel}
                </button>
                <Link
                  to={"/services/it/" + category.slug}
                  className="px-6 py-3 bg-white/70 border border-[#D4AF37]/30 rounded-xl hover:bg-white/80 transition font-semibold"
                >
