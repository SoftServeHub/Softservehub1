            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.deliverySteps ?? []).map((s: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-5 font-bold text-[#0f172a]">{s.title}</h3>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-4 text-lg font-bold text-[#b45309] group-hover:text-[#1f1605] transition-colors duration-300">
                    {w.title}
                  </h3>
