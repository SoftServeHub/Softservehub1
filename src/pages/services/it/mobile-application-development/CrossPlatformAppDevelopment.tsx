    ...
    <section className="service-detail-page relative min-h-screen bg-[#fffCF0] text-[#1f1605] overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="rounded-[32px] overflow-hidden border border-[#D4AF37]/30 bg-white/70 backdrop-blur-2xl">
            ...
            <div className="relative px-5 py-10 sm:px-8 sm:py-14 md:px-14 md:py-20 text-center">
              ...
              <p className="text-[#5b4520] mt-5 mx-auto max-w-3xl text-base sm:text-lg leading-relaxed">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
                <Link
                  to="/book-appointment"
                  className="px-8 py-4 rounded-2xl font-semibold bg-[#8a6b18] hover:bg-[#8a6b18] transition shadow-[0_0_40px_rgba(138,107,24,0.35)] text-center"
                >
                ...
                <a
                  href="#contact"
                  className="px-8 py-4 rounded-2xl font-semibold bg-white/70 border border-[#D4AF37]/30 hover:bg-white/80 transition text-center"
                >
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {(content?.topBlocks ?? []).map((b: { title: string; desc: string }) => (
              <div
                key={b.title}
                className="group relative overflow-hidden rounded-2xl border border-[#D4AF37]/30 bg-white/70 p-7 transition-all duration-300 hover:-translate-y-2 hover:border-[#f6df9a]/50 hover:bg-white/75 hover:shadow-[0_0_35px_rgba(212,175,55,0.18)]"
              >
                ...
                <h3 className="relative text-xl font-bold text-[#b45309] transition-colors duration-300 group-hover:text-[#b45309]">
                  {b.title}
                </h3>
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          ...
          {/* Overview */}
          <div className="rounded-3xl bg-white/70 border border-[#D4AF37]/30 p-6 sm:p-10">
          ...
          {/* Project Duration */}
          <div className="rounded-3xl border border-[#D4AF37]/30 bg-[#fffbeb] p-6 sm:p-10">
            ...
            <div className="mt-10 grid md:grid-cols-2 xl:grid-cols-3 gap-6">
              {(content?.projectDuration?.cards ?? []).map(
                (card: { title: string; desc: string }) => (
                  <div
                    key={card.title}
                    className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-[#D4AF37]/30 bg-white/75 p-7 text-left transition-all duration-300 hover:-translate-y-2 hover:border-[#f6df9a]/50 hover:shadow-[0_0_35px_rgba(212,175,55,0.18)]"
                  >
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.16),transparent_58%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          ...
          <div className="rounded-3xl bg-white/70 border border-[#D4AF37]/30 p-6 sm:p-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.deliverySteps ?? []).map((s: { title: string; desc: string }, idx: number) => (
                <div
                  key={s.title}
                  className="group relative overflow-hidden rounded-2xl border border-[#D4AF37]/30 bg-white/75 p-7 transition-all duration-300 hover:-translate-y-2 hover:border-[#D4AF37]/50 hover:shadow-[0_0_35px_rgba(212,175,55,0.16)]"
                >
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.14),transparent_60%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-[#BFA45F] font-bold transition-transform duration-300 group-hover:scale-105">
                    {idx + 1}
                  </div>
                  <h3 className="relative mt-5 font-bold text-[#0f172a] transition-colors duration-300 group-hover:text-[#1f1605]">
                    {s.title}
                  </h3>
                  <p className="relative mt-2 leading-relaxed text-[#67552b] transition-colors duration-300 group-hover:text-[#2f2208]">
                    {s.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="rounded-3xl bg-white/70 border border-[#D4AF37]/30 p-10">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight bg-gradient-to-r from-[#f6df9a] via-[#f6df9a] to-[#D4AF37] bg-clip-text text-transparent">
                    ...
                    <React.Fragment key={step.title}>
                      <div className="rounded-[22px] border border-[#D4AF37]/25 bg-[#f8fafc] p-5">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h3 className="text-lg font-semibold text-[#1f1605]">
                              {step.title}
                            </h3>
                    ...
                    (item: { icon: string; title: string; desc: string }, idx: number) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-xl font-semibold text-[#1f1605]">
                            {item.title}
                          </div>
                        </div>
                    ...
                    {(content?.architecture?.layers?.sideCards ?? []).map(
                      (card: { icon: string; title: string; desc: string }) => (
                        ...
                        >
                          ...
                          <p className="mt-3 text-sm leading-6 text-[#67552b]">
                            {card.desc}
                          </p>
                        </div>
                      )
          ...
          <div className="rounded-3xl bg-white/70 border border-[#D4AF37]/30 p-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: { title: string; desc: string }) => (
                <div
                  key={w.title}
                  className="group relative overflow-hidden rounded-2xl border border-[#D4AF37]/30 bg-white/75 p-7 transition-all duration-300 hover:-translate-y-2 hover:border-[#f6df9a]/50 hover:shadow-[0_0_35px_rgba(212,175,55,0.18)]"
                >
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.14),transparent_60%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <h3 className="relative text-lg font-bold text-[#b45309] transition-colors duration-300 group-hover:text-[#1f1605]">
                    {w.title}
                  </h3>
                  <p className="relative mt-2 leading-relaxed text-[#67552b] transition-colors duration-300 group-hover:text-[#2f2208]">
                    {w.desc}
          ...
          <div
            id="contact"
            className="rounded-3xl bg-white/70 border border-[#D4AF37]/30 p-6 sm:p-10"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-[#b45309]">
            ...
            <form onSubmit={onSubmit} className="mt-8 mx-auto max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/75 border border-[#D4AF37]/30"
              />
              ...
              <textarea
                ...
                className="w-full md:col-span-2 px-4 py-3 rounded-xl bg-white/75 border border-[#D4AF37]/30"
              />

              <div className="md:col-span-2 flex flex-col sm:flex-row gap-4">
                <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#BFA45F] hover:bg-[#BFA45F] transition font-semibold">
                ...
                <Link
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/70 border border-[#D4AF37]/30 hover:bg-white/80 transition font-semibold text-center"
                >
