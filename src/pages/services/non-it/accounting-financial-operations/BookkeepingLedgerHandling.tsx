...
const content: any = {
  ...
  heroSubtitle:
    "Softserve Hub provides reliable bookkeeping and ledger handling services that help businesses maintain accurate financial records, organize day-to-day transaction data, strengthen ledger accuracy and support better financial control, reporting and compliance across regular accounting operations.",
  ...
  whoWeAreText:
    "Softserve Hub delivers structured non-IT bookkeeping and financial operations services that improve record accuracy, ledger control and long-term accounting stability. We combine financial discipline, process clarity and practical execution to support dependable bookkeeping performance.",
  whoWeAreCards: [
    {
