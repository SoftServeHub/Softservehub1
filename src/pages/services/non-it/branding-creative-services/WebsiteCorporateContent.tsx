...
const content: any = {
  ...
  heroSubtitle:
    "Softserve Hub delivers professional website content services that help businesses improve search visibility, communicate their value clearly and convert website visitors into enquiries, leads and customers through SEO-optimized, brand-aligned and conversion-focused content.",
  ...
  whoWeAreText:
    "Softserve Hub delivers structured non-IT content and branding services that improve digital clarity, search visibility and long-term communication performance. We combine content strategy, SEO thinking and practical execution to build website messaging systems that support business growth.",
  whoWeAreCards: [
    {
            ...
            <div className="mt-10 xl:hidden">
              ...
              <div className="mt-6 space-y-5">
                <div className="rounded-[26px] border border-[#D4AF37]/30 bg-white/75 p-6 shadow-[0_10px_24px_rgba(15,23,42,0.2)]">
                  <div className="w-fit rounded-full bg-gradient-to-r from-[#8a6b18] to-[#BFA45F] px-6 py-2 text-base font-bold text-[#1f1605] shadow-[0_0_28px_rgba(212,175,55,0.2)]">
                    Delivery
                  </div>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: { title: string; desc: string }) => (
                ...
                >
                  ...
                  <p className="relative text-[#67552b] mt-2 leading-relaxed transition-colors duration-300 group-hover:text-[#2f2208]">{w.desc}</p>
                </div>
              ))}
            </div>
          </div>
