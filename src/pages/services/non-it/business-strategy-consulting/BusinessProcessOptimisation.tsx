...
const content: any = {
  ...
  heroSubtitle:
    "Softserve Hub helps businesses improve workflows, reduce operational costs and increase productivity through process optimization, workflow automation and structured business transformation.",
