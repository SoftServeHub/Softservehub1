...
const content: any = {
  ...
  heroSubtitle:
    "Softserve Hub delivers digital transformation consulting services that help organizations modernize business processes, operating models and technology ecosystems for long-term growth.",
  ...
  projectDuration: {
    ...
    cards: [
      ...
      {
        title: "Why Organizations Choose Softserve Hub",
  ...
  whoWeAreText:
    "Softserve Hub supports organizations with structured consulting and implementation services that modernize operations, strengthen execution quality and improve long-term business performance.",
  whoWeAreCards: [
    {
