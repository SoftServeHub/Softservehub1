...
const content: any = {
  ...
  heroSubtitle:
    "Softserve Hub is a performance marketing agency delivering strategic Google Ads and Meta Ads services that help businesses generate qualified leads, improve conversions, strengthen campaign efficiency and achieve measurable growth through data-driven paid advertising.",
